...
(defconst color--blue             "#028f47adffff")
(defconst color--blue-ncs         "#00008cccc7ad")
(defconst color--bubblegum        "#ffff8787d7d7")
(defconst color--cerulean         "#00007ae0a665")
(defconst color--cerulean-blue    "#28f551ebbfff")
(defconst color--corn             "#fae0ee135c28")
(defconst color--cornflower-blue  "#63d6947aee13")
(defconst color--crimson          "#dc28147a3d70")
(defconst color--cyan             "#0000b851eb84")
(defconst color--dark-lilac       "#5f5f0000ffff")
(defconst color--deep-red         "#5f5f00000000")
(defconst color--desert-sand      "#ee13ca3cb0a3")
(defconst color--dim-forest-green "#00005f5f0000")
(defconst color--dollar           "#0000afaf5f5f")
(defconst color--indigo           "#26247020b5c1")
(defconst color--key              "#d7d7afaf0000")
(defconst color--light-prune      "#87875f5f8787")
(defconst color--lilac            "#87875f5fffff")
(defconst color--new-york-pink    "#d709828e7fff")
(defconst color--pink             "#ffff5f5fffff")
(defconst color--purple           "#5f5f0000ffff")
(defconst color--serpentine       "#8787d7d70000")
(defconst color--vanilla          "#ffffffffe0e0")
...
(custom-theme-set-faces
 ...
 '(tab-bar-tab ((t (:foreground "grey55" :background "grey15"))))
 '(tab-bar-tab-inactive ((t (:foreground "grey40" :background "black"))))
